...
(define (final-cs135-grade m1 m2 final assi)
  (+ (* 0.1 m1) (* 0.2 m2)(* 0.45 final) (* 0.2 assi) (* 100 0.05)))

;;Question 4b, finds the minimum grade for the final exam to get an overall 60%

;;Final grade is worth 45%

(define (cs135-final-exam-grade-needed m1 m2 assi)
  (/ (- 60 (* 0.1 m1) (* 0.2 m2) (* 0.2 assi) (* 100 0.05)) 0.45))  
